...
# 新内容摄入
  ...
  11. 路由配置一下，刷新的时候报404
  12. 网站建设时间线拖得太长，导致很多包版本老化，抽个时间排查一下！
...
# 问题分析
1. 为什么要将service和blog这类模块分开，感觉反而加大了无效代码
2. 对于个人开发而言，过分的模块化反而加重开发
3. 模块化还是很有必要的，但是没必要通过blog进行转接，因为组件内部本就是冲突区域。
   1. 把接口请求这样的业务写进组件不一定会导致组件的不可扩展，可以明确组件的专一性